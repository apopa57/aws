This is an example of a SAM application that uses an Amazon EventBridge rule that triggers on a schedule to run at a specific rate.
...
======================
        ...
        =========================================
        Stack Name [sam-app]: event-bridge-schedule-lambda
...
```
AWS_PROFILE=... sam logs --stack-name event-bridge-schedule-lambda --tail
```
## Clean up
```
